...
highest.1940 <- Highest.Spending('X1940')
highest.1945 <- Highest.Spending('X1945')
highest.1950 <- Highest.Spending('X1950')
highest.1955 <- Highest.Spending('X1955')
highest.1960 <- Highest.Spending('X1960')
